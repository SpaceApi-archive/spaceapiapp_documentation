...
$page->addContent('
    <div class="tabbable tabs-left">
      <ul class="nav nav-tabs">
        <li class="active"><a href="#left-tab-examples" data-toggle="tab">Examples</a></li>
        <li><a href="#left-tab-filters" data-toggle="tab">Filters</a></li>
        <li><a href="#left-tab-reference" data-toggle="tab">Reference</a></li>
      </ul>
...
// first tab
$page->addContent('<div class="tab-pane active" id="left-tab-examples">');
...
// third tab
$page->addContent('<div class="tab-pane" id="left-tab-reference">');
